...
export default function MetaHDRProject() {
  ...
  const fetchPublication = useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        const pub = publications.find((p: Publication) => p.slug === 'metahdr');
        if (pub) {
          setPublication(pub);
        } else {
          notFound();
        ...
        <div className="space-y-6">
          ...
          <section className="section-card">
            ...
            <p className="text-neutral-700 leading-relaxed text-base">
              This is the MetaHDR project page. Add your project details, description, and information here.
            </p>
          </section>
