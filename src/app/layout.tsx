                ...
                {navItems.map((item, index) => (
                  <li key={item.href} className="relative">
                    ...
                    >
                      ...
                      {/* Active page indicator - copper bar on top */}
                      {isActive(item.href) && (
                        <div className="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-dome-copper via-dome-copper to-dome-copper/80 shadow-lg rounded-b-md" />
                      )}
                    </Link>
                  </li>
                ))}
