...
function getDefaultContent(): WebsiteContent {
  return {
    homepage: {
      aboutUs: "Welcome to the Visual Computing and Augmented Intelligence Lab at UNC Chapel Hill. We've been around UNC Computer Science since 1978, with research such as Telepresence, Virtual Reality, Pixel-Planes, Head & Body Trackers, 3D Ultrasound Displays, Office of the Future, Being-There Centre (with ETH Zurich and NTU Singapore) — see past research. Currently our team is dedicated to advancing research in computational imaging, visual perception, and AI-driven solutions. We collaborate across disciplines to develop pioneering technologies that shape the future of visual computing.",
